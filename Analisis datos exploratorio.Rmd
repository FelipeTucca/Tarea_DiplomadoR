...
## **~H1~**: $$ \beta_{j} ≠ 0 ; j= 1,2,..., k


#### Ajuste del modelo múltiple y evaluación de supuestos

El modelo cumple con los tres supuestos de linealidad
El modelo de regresión lineal nos entrega como resultado 
...
```{r comparación de modelos completo y simples, echo=TRUE}
