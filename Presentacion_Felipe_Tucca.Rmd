...
```{r, echo = FALSE, out.width= '80%', fig.align='center', fig.cap= "Histograma biomasa muerta (toneladas) por causa"}
...
```{r, echo = FALSE, out.width= '80%', fig.align='center', fig.cap= "Boxplot biomasa muerta por año y causa"}
...
## **Tabla resumen de la biomasa muerta por causa**
 ...
 Descripción estadística de la biomasa muerta según causa: 
...
## **Comparación de modelos por RSS**
