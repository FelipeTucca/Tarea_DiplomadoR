...
subtitle: Mortalidad en Salmo salar por bloom de algas y OD
institute: INTESAL
---
...
- El salmón del Atñantico (*Salmo salar*) es la especie más cultivada en el barrio.
...
```{r, message=FALSE, out.width= '10%', fig.align='center'}
