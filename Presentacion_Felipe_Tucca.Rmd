...
```{r, echo = FALSE, out.width= '75%', fig.align='center', fig.cap= "Histograma biomasa muerta (toneladas) por causa"}
...
```{r, echo = FALSE, out.width= '75%', fig.align='center', fig.cap= "Boxplot biomasa muerta por año y causa"}
...
```{r, echo = FALSE, out.width= '75%', fig.align='center', fig.cap= "Biomasa muerta por semana y causa"}
...
**Hipótesis nula (H_{0})**: Existe similitud en la biomasa muerta entre centros/semanas/años.

**Hipótesis alternativa (H_{1})**: No existe similitud en la biomasa muerta entre centros/semanas/años.



## **Análisis estadísitico de los datos: Modelo lineal múltiple**
...
```{r message=FALSE, out.width= '75%', fig.align='left'}
anova(modelo1_anova1_centro, modelo2_anova2_mes, modelo3_anova3_año, lm.aov_biomasa) %>% pander()
```

```{r message=FALSE, out.width= '75%', fig.align='right'}
